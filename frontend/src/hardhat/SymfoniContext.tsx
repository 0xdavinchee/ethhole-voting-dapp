...
import { Voting__factory } from "./typechain/factories/Voting__factory";
...
export const VotingContext = React.createContext<SymfoniVoting>(emptyContract);
...
export interface SymfoniVoting {
    instance?: Voting;
    factory?: Voting__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [Voting, setVoting] = useState<SymfoniVoting>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setVoting(getVoting(_provider, _signer))
                finish(text)
            }
    ...
    const getVoting = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"
        const instance = _signer ? Voting__factory.connect(contractAddress, _signer) : Voting__factory.connect(contractAddress, _provider)
        const contract: SymfoniVoting = {
            instance: instance,
            factory: _signer ? new Voting__factory(_signer) : undefined,
        }
        return contract
    }
        ;
